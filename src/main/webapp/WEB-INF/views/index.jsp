...
<body>
    ...
    <!-- Start Header Area -->
    <header class="header navbar-area" style="border-bottom: none;">
    
        <!-- Start Topbar -->
        <div class="topbar" style="background-color: #5f0080">
            <div class="container">
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-4 col-md-4 col-12">
                        <div class="top-middle">
                            <a class="useful-links" style="color: white; font-weight: bold;">지금 가입하고 인기 상품 100원에 받아가세요!</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <!-- Start Header Middle -->
        <div class="header-middle" style="border-bottom: none; padding: 10px">
            <div class="container">
                <div class="row align-items-center">
                	<div class="col-lg-4 col-md-4 d-xs-none"></div>
                    <div class="col-lg-4 col-md-4 d-xs-none" style="text-align: center;">
						<!-- Start Header Logo -->
                        <a class="navbar-brand" href="index.html">
                            <img src="resources/assets/images/logo/logo.png" alt="Logo" style="width: 120px">
                        </a>
                        <!-- End Header Logo -->
                    </div>
                    <div class="col-lg-4 col-md-4 col-12">
                        <div class="navbar-cart">
                        	<c:if test="${empty member}">
			                    <ul class="user-login">
				                    <li style="display: inline-block; border-right: 1pxsolidrgba(255,255,255,.459); padding: 0 10px; white-space: nowrap;">
				                    	<a href="login.html" style="color: #5f0080">회원가입</a>
				                    </li>
				                    <li style="display: inline-block;">
				                    	<a href="register.html" style="color: black;">로그인</a>
				                    </li>
			                    </ul>
		                    </c:if>
            ...
            <div class="row align-items-center">
                <div class="col-lg-11 col-md-6 col-12">
                    <div class="nav-inner">
                        ...
                        <div class="mega-category-menu" style="border-right: none;">
                        ...
                        <!-- Start Navbar -->
                        <nav class="navbar navbar-expand-lg" style="padding-right: 100px">
                        ...
                        <!-- Start search 검색 -->
                        <form action="/market/product/list" method="get" class="input-group-sm">
                        	<div class="input-group mb-3" style="padding-top: 18px">
                        		<select name="keyword" hidden="">
									<option value="proName" hidden="" />
								</select>
							  <input type="search" value="${pager.search}" class="form-control" placeholder="Search" aria-label="Search" name="search" style="border-radius: 10px">
							  <button class="btn btn-outline-secondary" type="submit" style="border-radius: 10px">Search</button>
							</div>
						</form>
                        <!-- End search -->
                    </div>
